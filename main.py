import webbrowser
webbrowser.open("https://t.me/Voltrons")
...
class ziddi:
    ...
    async def report_channel(self):
        channel_link = input("Channel links: ").strip() # by @Voltrons
        ...
        try:
            ...
            for msg_num, message in enumerate(messages, 1):
                ...
                for report_num in range(1, reports_for_this_msg + 1):
                    try:
                        ...
                        if report_num % 5 == 0:
                            print(f"   {report_num}/{reports_for_this_msg} report sent ✅ ") #@Voltrons
            ...
            print(f"Telegram: @meta_server | @Voltrons !")
